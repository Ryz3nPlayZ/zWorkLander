          ...
          {platforms.map((p, i) => {
            ...
            return (
              <div
                ...
                className={`relative rounded-2xl border p-10 md:p-12 text-center transition-shadow duration-300 ${
                  p.comingSoon
              ...
              >
                ...
                <div className="inline-flex items-center justify-center rounded-2xl bg-[#25252a] p-5 text-[#f7f6f3] mb-8">
                  <Icon className="h-8 w-8" strokeWidth={1.5} />
                </div>
                <h3
                  className="text-3xl md:text-4xl font-semibold tracking-tight text-[#f7f6f3] mb-4"
                  style={serif}
                >
                  {p.label}
                </h3>
                <p className="text-[15px] text-[#a09e98] leading-relaxed mb-8">
                  {p.label === "macOS"
